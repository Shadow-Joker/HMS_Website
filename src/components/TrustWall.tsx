      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-[#769382]/20">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 sm:gap-14 opacity-85 hover:opacity-100 transition-opacity font-nebula">
            ...
            <div className="font-bold text-xl tracking-wider text-[#769382]">CERNER</div>
            <div className="font-bold text-xl tracking-wider text-[#1E2D26]">MEDITECH</div>
            <div className="font-bold text-xl tracking-wider text-[#769382]">HL7 FHIR</div>
            <div className="font-bold text-xl tracking-wider text-[#1E2D26]">ALLSCRIPTS</div>
          </div>
        </div>
