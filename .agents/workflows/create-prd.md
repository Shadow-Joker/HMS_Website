...
- **When defining architecture, APIs, or technology choices, favor verifiable and current information over assumptions**

### 3. External Knowledge & Validation (Important)

- **Use web search when:**
  - Evaluating technology choices, frameworks, or platforms
  - Making claims about industry standards, best practices, or limitations
  - Defining APIs, protocols, or deployment approaches that may change over time
- **Use Context7 aggressively when:**
  - Referencing framework behavior, library APIs, or configuration options
  - Defining architecture patterns tied to specific technologies
  - Specifying versions, defaults, or deprecations
- Prefer *latest stable behavior* over legacy patterns
- If uncertainty exists, explicitly call it out as an assumption
...
- ✅ Technology choices are justified with up-to-date reasoning
...
- **Do not hesitate to consult web search or use Context7 to reduce ambiguity or risk**
...
- This command contains the complete PRD template structure
